...
static stat  g_state = stat::state_uninitialized;

static void initialize() {

    assert(g_state == stat::state_uninitialized, "wrong sequence");
    g_state = stat::state_error;
...
namespace { // Do not export.
    ...
    public:
        SymbolEngineEntry() {
            ...
            if (g_state == stat::state_uninitialized) {
                initialize();
            }
        }
        ~SymbolEngineEntry() {
